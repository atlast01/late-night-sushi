          ...
          <ScrollAnimate>
            <div className="bg-card border border-border rounded-sm p-8 mb-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h1 className="font-heading text-2xl text-foreground tracking-wider">{user.name}</h1>
                  <p className="font-body text-muted-foreground text-sm">{user.email}</p>
                </div>
                {isAdmin && (
                  <span className="ml-auto inline-flex items-center gap-1.5 px-3 py-1 bg-primary/20 text-primary font-body text-xs tracking-wider uppercase rounded-sm">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 border border-border text-muted-foreground font-body text-sm rounded-sm hover:border-destructive hover:text-destructive transition-colors"
                >
